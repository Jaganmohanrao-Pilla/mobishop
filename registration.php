...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
    <title>Mobishop Registration</title>
    <style>
        body{
...
<header style="background-color:grey;color:white;text-align: center; height: 70px; padding: 20px; " >
    ...
    <div class="form-group">
        ...
        <input type="text" id="scode" name="scode" class="form-control" required placeholder=" 4 digit code to reset password if you forgot your password"><br>
    </div>
            <div class="form-group">
