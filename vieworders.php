...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['increase'])) {
        ...
        $query = "UPDATE orders SET quantity = '$currentquantity', total_price = '$total_price' WHERE id = '$order_id' AND user_id = '$user_id'";
        ...
        if($currentquantity==1){
            ...
            $query = "DELETE FROM orders WHERE user_id = '$user_id' AND id = '$order_id' AND item_id = '$itemId'";
        ...
        $currentquantity=$currentquantity- 1;
        $total_price = $currentquantity * $item['price'];
        $query = "UPDATE orders SET quantity = '$currentquantity',total_price = '$total_price' WHERE id = '$order_id' AND user_id = '$user_id' AND '$currentquantity' >0";
        ...
        mysqli_query($conn, $query);
        echo "<script>alert('Orders list cleared successfully');</script>";
        header("Refresh:0; url=vieworders.php");
    }
}
